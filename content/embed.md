...
var max\_scroll = this.scrollHeight - this.clientHeight;
var current\_scroll = this.scrollTop;
var bottom = 100;
if ( current\_scroll + bottom >= max\_scroll ) {
var ul = document.getElementsByTagName( "ul" )\[ 0 ];
var current = parseInt( ul.dataset.current, 10 );
var li = document.getElementsByTagName( "li" )\[ current ];
var new\_li = li.cloneNode( true );
ul.appendChild( new\_li );
